...
public ItemCl(int itemid, String itemname, int costprice, int sellprice, LocalDate dom, LocalDate doe) {
	super();
	this.itemid = itemid;
...
ItemCl i=null;
public static boolean createObject(ItemCl i) {
			...
			if(i.sellprice>0 && i.costprice>0)
				if(i.doe!=LocalDate.now())
					if(i.sellprice!=i.costprice)
						i =new ItemCl(i.itemid,i.itemname,i.costprice,i.sellprice,i.dom,i.doe);
...
public static void main(String[] args) {
	...
	System.out.println(ItemCl.createObject(i));
}
}
